...
window.dom = {
  ...
  create: function create(string) {
    var container = document.createElement("template"); //trim去掉两头的空格
  ...
  after: function after(node, node2) {
    console.log(node.nextSibling); //找到节点的爸爸，调用爸爸的方法，把新节点插入下一个节点的前面
  ...
  wrap: function wrap(node, parent) {
    ...
    dom.before(node, parent); //把这个节点删除，添加为新节点的子节点
...
},{}]},{},["C:/Users/laoduan/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","dom.js"], null)
